...
<div class="card">
    <div class="card-header">
        Visualizar Instalação de Funcionario
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.instalars.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.instalar.fields.id') }}
                        </th>
                        <td>
                            {{ $instalar->id }}
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                          @foreach($instalar->funcaos as $key => $funcao)
                              <span class="label label-info">{{ $funcao->titulo }}</span>
                          @endforeach
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            {{ $instalar->profissional->nome_completo }} </p>
                        </td>
                    </tr>
                    <tr>
                        <th>
