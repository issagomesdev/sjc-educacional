...
<div class="card">
    <div class="card-header">
        Visualizar Vagas da Turma
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.vagas.index') }}">
              ...
              <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.teams.show', $vaga->escola->id) }}"> {{ $vaga->escola->name ?? '' }} </a>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                          <a href="{{ route('admin.turmas.show', $vaga->turma->id) }}"> {{ $vaga->turma->serie ?? '' }} {{ $vaga->turma->identificacao ?? '' }} </a>
                        </td>
                    </tr>
                    <tr>
                        <th>
