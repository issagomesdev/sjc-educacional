...
<div class="card">
    <div class="card-header">
        Visualizar Rematricula
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.rematriculas.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.rematricula.fields.id') }}
                        </th>
                        <td>
                            {{ $rematricula->id }}
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $rematricula->turma->ano_serie ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.rematricula.fields.alunos') }}
                        </th>
                        <td>
                            @foreach($rematricula->alunos as $key => $alunos)
                                <span class="label label-info">{{ $alunos->nome_completo }},</span>
                            @endforeach
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            {{ $rematricula->turma_nova->ano_serie ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
