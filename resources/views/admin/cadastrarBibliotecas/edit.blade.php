...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cadastrar-bibliotecas.update", [$cadastrarBiblioteca->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nome_da_biblioteca">{{ trans('cruds.cadastrarBiblioteca.fields.nome_da_biblioteca') }}</label>
                <input class="form-control {{ $errors->has('nome_da_biblioteca') ? 'is-invalid' : '' }}" type="text" name="nome_da_biblioteca" id="nome_da_biblioteca" value="{{ old('nome_da_biblioteca', $cadastrarBiblioteca->nome_da_biblioteca) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\CadastrarBiblioteca::LOCALIZACAO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('localizacao') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="localizacao_{{ $key }}" name="localizacao" value="{{ $key }}" {{ old('localizacao', $cadastrarBiblioteca->localizacao) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado" id="estado">
                    ...
                    @foreach(App\Models\CadastrarBiblioteca::ESTADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado', $cadastrarBiblioteca->estado) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $cadastrarBiblioteca->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $cadastrarBiblioteca->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('endereco') ? 'is-invalid' : '' }}" type="text" name="endereco" id="endereco" value="{{ old('endereco', $cadastrarBiblioteca->endereco) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('domingo') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="domingo" id="domingo" value="1" {{ $cadastrarBiblioteca->domingo || old('domingo', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_1') ? 'is-invalid' : '' }}" type="text" name="horario_1" id="horario_1" value="{{ old('horario_1', $cadastrarBiblioteca->horario_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_1_2') ? 'is-invalid' : '' }}" type="text" name="horario_1_2" id="horario_1_2" value="{{ old('horario_1_2', $cadastrarBiblioteca->horario_1_2) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('segunda') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="segunda" id="segunda" value="1" {{ $cadastrarBiblioteca->segunda || old('segunda', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_2') ? 'is-invalid' : '' }}" type="text" name="horario_2" id="horario_2" value="{{ old('horario_2', $cadastrarBiblioteca->horario_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_2_2') ? 'is-invalid' : '' }}" type="text" name="horario_2_2" id="horario_2_2" value="{{ old('horario_2_2', $cadastrarBiblioteca->horario_2_2) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('terca_feira') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="terca_feira" id="terca_feira" value="1" {{ $cadastrarBiblioteca->terca_feira || old('terca_feira', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_3') ? 'is-invalid' : '' }}" type="text" name="horario_3" id="horario_3" value="{{ old('horario_3', $cadastrarBiblioteca->horario_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_3_2') ? 'is-invalid' : '' }}" type="text" name="horario_3_2" id="horario_3_2" value="{{ old('horario_3_2', $cadastrarBiblioteca->horario_3_2) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('quarta_feira') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="quarta_feira" id="quarta_feira" value="1" {{ $cadastrarBiblioteca->quarta_feira || old('quarta_feira', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_4') ? 'is-invalid' : '' }}" type="text" name="horario_4" id="horario_4" value="{{ old('horario_4', $cadastrarBiblioteca->horario_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_4_2') ? 'is-invalid' : '' }}" type="text" name="horario_4_2" id="horario_4_2" value="{{ old('horario_4_2', $cadastrarBiblioteca->horario_4_2) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('quinta_feira') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="quinta_feira" id="quinta_feira" value="1" {{ $cadastrarBiblioteca->quinta_feira || old('quinta_feira', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_5') ? 'is-invalid' : '' }}" type="text" name="horario_5" id="horario_5" value="{{ old('horario_5', $cadastrarBiblioteca->horario_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_5_2') ? 'is-invalid' : '' }}" type="text" name="horario_5_2" id="horario_5_2" value="{{ old('horario_5_2', $cadastrarBiblioteca->horario_5_2) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sexta_feira') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sexta_feira" id="sexta_feira" value="1" {{ $cadastrarBiblioteca->sexta_feira || old('sexta_feira', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_6') ? 'is-invalid' : '' }}" type="text" name="horario_6" id="horario_6" value="{{ old('horario_6', $cadastrarBiblioteca->horario_6) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_6_2') ? 'is-invalid' : '' }}" type="text" name="horario_6_2" id="horario_6_2" value="{{ old('horario_6_2', $cadastrarBiblioteca->horario_6_2) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sabado') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sabado" id="sabado" value="1" {{ $cadastrarBiblioteca->sabado || old('sabado', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_7') ? 'is-invalid' : '' }}" type="text" name="horario_7" id="horario_7" value="{{ old('horario_7', $cadastrarBiblioteca->horario_7) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_7_2') ? 'is-invalid' : '' }}" type="text" name="horario_7_2" id="horario_7_2" value="{{ old('horario_7_2', $cadastrarBiblioteca->horario_7_2) }}">
