...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cadastros.update", [$cadastro->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <label class="required" for="nome_completo">{{ trans('cruds.cadastro.fields.nome_completo') }}</label>
                <input class="form-control {{ $errors->has('nome_completo') ? 'is-invalid' : '' }}" type="text" name="nome_completo" id="nome_completo" value="{{ old('nome_completo', $cadastro->nome_completo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="number" name="codigo_do_inep" id="codigo_do_inep" value="{{ old('codigo_do_inep', $cadastro->codigo_do_inep) }}">
                <span class="help-block"> </span>
            </div>
            <div class="form-group">
                <label for="data_de_nascimento">{{ trans('cruds.cadastro.fields.data_de_nascimento') }}</label>
                <div class="group">
                <input class="form-control date {{ $errors->has('data_de_nascimento') ? 'is-invalid' : '' }}" type="text" name="data_de_nascimento" id="data_de_nascimento" value="{{ old('data_de_nascimento', $cadastro->data_de_nascimento) }}">
                <input class="control" type="number" name="ano_de_nascimento" id="ano_de_nascimento" value="{{ old('ano_de_nascimento', $cadastro->ano_de_nascimento) }}">
                </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Cadastro::GENERO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('genero') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="genero_{{ $key }}" name="genero" value="{{ $key }}" {{ old('genero', $cadastro->genero) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nacionalidade') ? 'is-invalid' : '' }}" type="text" name="nacionalidade" id="nacionalidade" value="{{ old('nacionalidade', $cadastro->nacionalidade) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Cadastro::LOCALIZACAO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('localizacao') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="localizacao_{{ $key }}" name="localizacao" value="{{ $key }}" {{ old('localizacao', $cadastro->localizacao) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado" id="estado">
                    ...
                    @foreach(App\Models\Cadastro::ESTADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado', $cadastro->estado) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $cadastro->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $cadastro->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('endereco') ? 'is-invalid' : '' }}" type="text" name="endereco" id="endereco" value="{{ old('endereco', $cadastro->endereco) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('email_do_aluno') ? 'is-invalid' : '' }}" name="email_do_aluno_id" id="email_do_aluno_id">
                    @foreach($email_do_alunos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('email_do_aluno_id') ? old('email_do_aluno_id') : $cadastro->email_do_aluno->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_mail_de_contato') ? 'is-invalid' : '' }}" type="text" name="e_mail_de_contato" id="e_mail_de_contato" value="{{ old('e_mail_de_contato', $cadastro->e_mail_de_contato) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('certidao_de_nascimento') ? 'is-invalid' : '' }}" type="text" name="certidao_de_nascimento" id="certidao_de_nascimento" value="{{ old('certidao_de_nascimento', $cadastro->certidao_de_nascimento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_do_nis') ? 'is-invalid' : '' }}" type="text" name="numero_do_nis" id="numero_do_nis" value="{{ old('numero_do_nis', $cadastro->numero_do_nis) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_do_cpf') ? 'is-invalid' : '' }}" type="text" name="numero_do_cpf" id="numero_do_cpf" value="{{ old('numero_do_cpf', $cadastro->numero_do_cpf) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_da_identidade') ? 'is-invalid' : '' }}" type="text" name="numero_da_identidade" id="numero_da_identidade" value="{{ old('numero_da_identidade', $cadastro->numero_da_identidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_de_telefone') ? 'is-invalid' : '' }}" type="text" name="numero_de_telefone" id="numero_de_telefone" value="{{ old('numero_de_telefone', $cadastro->numero_de_telefone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ocupacao_do_aluno') ? 'is-invalid' : '' }}" type="text" name="ocupacao_do_aluno" id="ocupacao_do_aluno" value="{{ old('ocupacao_do_aluno', $cadastro->ocupacao_do_aluno) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_responsavel') ? 'is-invalid' : '' }}" type="text" name="nome_responsavel" id="nome_responsavel" value="{{ old('nome_responsavel', $cadastro->nome_responsavel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profissao_do_responsavel') ? 'is-invalid' : '' }}" type="text" name="profissao_do_responsavel" id="profissao_do_responsavel" value="{{ old('profissao_do_responsavel', $cadastro->profissao_do_responsavel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contato_de_emergencia') ? 'is-invalid' : '' }}" type="text" name="contato_de_emergencia" id="contato_de_emergencia" value="{{ old('contato_de_emergencia', $cadastro->contato_de_emergencia) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_do_responsavel_2') ? 'is-invalid' : '' }}" type="text" name="nome_do_responsavel_2" id="nome_do_responsavel_2" value="{{ old('nome_do_responsavel_2', $cadastro->nome_do_responsavel_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profissao_do_responsavel_2') ? 'is-invalid' : '' }}" type="text" name="profissao_do_responsavel_2" id="profissao_do_responsavel_2" value="{{ old('profissao_do_responsavel_2', $cadastro->profissao_do_responsavel_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contato_de_emergencia_2') ? 'is-invalid' : '' }}" type="text" name="contato_de_emergencia_2" id="contato_de_emergencia_2" value="{{ old('contato_de_emergencia_2', $cadastro->contato_de_emergencia_2) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" name="email_do_responsavel_id" id="email_do_responsavel_id">
                    @foreach($email_do_responsavel as $id => $entry)
                        <option value="{{ $id }}" {{ (old('email_do_responsavel_id') ? old('email_do_responsavel_id') : $cadastro->email_do_responsavel->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('cor_raca') ? 'is-invalid' : '' }}" name="cor_raca" id="cor_raca">
                    ...
                    @foreach(App\Models\Cadastro::COR_RACA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('cor_raca', $cadastro->cor_raca) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo_sanguineo') ? 'is-invalid' : '' }}" type="text" name="tipo_sanguineo" id="tipo_sanguineo" value="{{ old('tipo_sanguineo', $cadastro->tipo_sanguineo) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Cadastro::PROBLEMA_DE_SAUDE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('problema_de_saude') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="problema_de_saude_{{ $key }}" name="problema_de_saude" value="{{ $key }}" {{ old('problema_de_saude', $cadastro->problema_de_saude) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sesim_qual') ? 'is-invalid' : '' }}" type="text" name="sesim_qual" id="sesim_qual" value="{{ old('sesim_qual', $cadastro->sesim_qual) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Cadastro::ALGUM_MEDICAMENTO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('algum_medicamento') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="algum_medicamento_{{ $key }}" name="algum_medicamento" value="{{ $key }}" {{ old('algum_medicamento', $cadastro->algum_medicamento) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sesim_qual_2') ? 'is-invalid' : '' }}" type="text" name="sesim_qual_2" id="sesim_qual_2" value="{{ old('sesim_qual_2', $cadastro->sesim_qual_2) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Cadastro::ALGUMA_DEFICIENCIA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('alguma_deficiencia') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="alguma_deficiencia_{{ $key }}" name="alguma_deficiencia" value="{{ $key }}" {{ old('alguma_deficiencia', $cadastro->alguma_deficiencia) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sesim_qual_3') ? 'is-invalid' : '' }}" type="text" name="sesim_qual_3" id="sesim_qual_3" value="{{ old('sesim_qual_3', $cadastro->sesim_qual_3) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Cadastro::ALGUMA_ALERGIA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('alguma_alergia') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="alguma_alergia_{{ $key }}" name="alguma_alergia" value="{{ $key }}" {{ old('alguma_alergia', $cadastro->alguma_alergia) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sesim_qual_4') ? 'is-invalid' : '' }}" type="text" name="sesim_qual_4" id="sesim_qual_4" value="{{ old('sesim_qual_4', $cadastro->sesim_qual_4) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('vai_a_escola') ? 'is-invalid' : '' }}" name="vai_a_escola" id="vai_a_escola" onchange="showDiv('rota', this)">
                    ...
                    @foreach(App\Models\Cadastro::VAI_A_ESCOLA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('vai_a_escola', $cadastro->vai_a_escola) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                ...
                <select class="form-control select2 {{ $errors->has('rota_percorrida') ? 'is-invalid' : '' }}" name="rota_percorrida_id" id="rota_percorrida_id">
                  <option value=""> Selecione por favor </option>
                    @foreach($rota_percorridas as $rota_percorridas)
                        <option value="{{ $rota_percorridas->id }}" {{ (old('rota_percorrida_id') ? old('rota_percorrida_id') : $cadastro->rota_percorrida->id ?? '') == $rota_percorridas->id ? 'selected' : '' }}> Veiculo deixa {{ $rota_percorridas->origem }} as {{ $rota_percorridas->horario_de_saida }} e tem previsão de chegar a {{ $rota_percorridas->destino }} as {{ $rota_percorridas->horario_de_destino }} </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Cadastro::PROGRAMA_MAISEDUCA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('programa_maiseduca') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="programa_maiseduca_{{ $key }}" name="programa_maiseduca" value="{{ $key }}" {{ old('programa_maiseduca', $cadastro->programa_maiseduca) === (string) $key ? 'checked' : '' }}>
