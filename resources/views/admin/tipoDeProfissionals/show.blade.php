...
<div class="card">
    <div class="card-header">
        Visualizar Tipo de Profissional
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.tipo-de-profissionals.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.tipoDeProfissional.fields.id') }}
                        </th>
                        <td>
                            {{ $tipoDeProfissional->id }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.tipoDeProfissional.fields.educador') }}
                        </th>
                        <td>
                            {{ App\Models\TipoDeProfissional::EDUCADOR_RADIO[$tipoDeProfissional->educador] ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
