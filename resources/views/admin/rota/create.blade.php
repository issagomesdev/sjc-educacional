...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rota.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('horario_de_saida') ? 'is-invalid' : '' }}" type="text" name="horario_de_saida" id="horario_de_saida" value="{{ old('horario_de_saida') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('origem') ? 'is-invalid' : '' }}" type="text" name="origem" id="origem" value="{{ old('origem', '') }}">
            ...
            <div class="form-group">
                <label for="horario_de_destino">Horário De Chegada</label>
                <input class="form-control timepicker {{ $errors->has('horario_de_destino') ? 'is-invalid' : '' }}" type="text" name="horario_de_destino" id="horario_de_destino" value="{{ old('horario_de_destino') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quilometros_percorridos') ? 'is-invalid' : '' }}" type="text" name="quilometros_percorridos" id="quilometros_percorridos" value="{{ old('quilometros_percorridos', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('veiculo_responsavel') ? 'is-invalid' : '' }}" name="veiculo_responsavel_id" id="veiculo_responsavel_id">
                  ...
                  <option value="{{ $veiculo->id }}" {{ old('veiculo_responsavel_id') == $veiculo->id ? 'selected' : '' }}> Marca: {{ $veiculo->marca }}, Placa: {{ $veiculo->placa ?? '' }}, {{ $veiculo->descricao ?? '' }} </option>
                  @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('motorista_responsavel') ? 'is-invalid' : '' }}" name="motorista_responsavel_id" id="motorista_responsavel_id">
                    @foreach($motorista_responsavels as $id => $entry)
                        <option value="{{ $id }}" {{ old('motorista_responsavel_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
