...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-rotaPercorridaCadastros">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.cadastro.fields.assinatura') }}
                        </th>
                        <th>
                            {{ trans('cruds.cadastro.fields.created_at') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@endcan
  ...
  let table = $('.datatable-rotaPercorridaCadastros:not(.ajaxTable)').DataTable({ buttons: dtButtons })
