...
<div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route("admin.profissionais.update", [$profissionai->id]) }}" enctype="multipart/form-data">
         @method('PUT')
         @csrf
            <div class="form-group">
                <label class="required" for="nome_completo">Nome Completo</label>
                <input class="form-control {{ $errors->has('nome_completo') ? 'is-invalid' : '' }}" type="text" name="nome_completo" id="nome_completo" value="{{ old('nome_completo', $profissionai->nome_completo) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_de_nascimento') ? 'is-invalid' : '' }}" type="text" name="data_de_nascimento" id="data_de_nascimento" value="{{ old('data_de_nascimento', $profissionai->data_de_nascimento) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Profissionai::GENERO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('genero') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="genero_{{ $key }}" name="genero" value="{{ $key }}" {{ old('genero', $profissionai->genero) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <label for="numero_de_contato">Nome do pai</label>
                <input class="form-control {{ $errors->has('nome_do_pai') ? 'is-invalid' : '' }}" type="text" name="nome_do_pai" id="nome_do_pai" value="{{ old('nome_do_pai', $profissionai->nome_do_pai) }}">
                <span class="help-block"> </span>
            </div>
            <div class="form-group">
                <label for="numero_de_contato">Nome da mãe</label>
                <input class="form-control {{ $errors->has('nome_da_mae') ? 'is-invalid' : '' }}" type="text" name="nome_da_mae" id="nome_da_mae" value="{{ old('nome_da_mae', $profissionai->nome_da_mae) }}">
                <span class="help-block"> </span>
            </div>
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado_civil') ? 'is-invalid' : '' }}" name="estado_civil" id="estado_civil">
                    ...
                    @foreach(App\Models\Profissionai::ESTADO_CIVIL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado_civil', $profissionai->estado_civil) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cpf') ? 'is-invalid' : '' }}" type="text" name="cpf" id="cpf" value="{{ old('cpf', $profissionai->cpf) }}">
                <span class="help-block"> </span>
            </div>
            <div class="form-group">
                <label for="numero_de_contato">Registro Geral (RG)</label>
                <input class="form-control {{ $errors->has('rg') ? 'is-invalid' : '' }}" type="text" name="rg" id="rg" value="{{ old('rg', $profissionai->rg) }}">
                <span class="help-block"> </span>
            </div>
            <div class="form-group">
                ...
                @foreach(App\Models\Profissionai::LOCALIZACAO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('localizacao') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="localizacao_{{ $key }}" name="localizacao" value="{{ $key }}" {{ old('localizacao', $profissionai->localizacao) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado" id="estado">
                    ...
                    @foreach(App\Models\Profissionai::ESTADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado', $profissionai->estado ) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $profissionai->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $profissionai->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('endereco') ? 'is-invalid' : '' }}" type="text" name="endereco" id="endereco" value="{{ old('endereco', $profissionai->endereco) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ano_de_contratacao') ? 'is-invalid' : '' }}" type="number" name="ano_de_contratacao" id="ano_de_contratacao" value="{{ old('ano_de_contratacao', $profissionai->ano_de_contratacao) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('situacao_de_contratacao') ? 'is-invalid' : '' }}" name="situacao_de_contratacao" id="situacao_de_contratacao">
                    ...
                    @foreach(App\Models\Profissionai::SITUACAO_DE_CONTRATACAO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('situacao_de_contratacao', $profissionai->situacao_de_contratacao) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('escolaridade') ? 'is-invalid' : '' }}" name="escolaridade" id="escolaridade">
                    ...
                    @foreach(App\Models\Profissionai::ESCOLARIDADE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('escolaridade', $profissionai->escolaridade) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ensino_medio_cursado') ? 'is-invalid' : '' }}" name="ensino_medio_cursado" id="ensino_medio_cursado">
                    ...
                    @foreach(App\Models\Profissionai::ENSINO_MEDIO_CURSADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ensino_medio_cursado', $profissionai->ensino_medio_cursado) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('pos_concluidas') ? 'is-invalid' : '' }}" name="pos_concluidas" id="pos_concluidas">
                    ...
                    @foreach(App\Models\Profissionai::POS_CONCLUIDAS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('pos_concluidas', $profissionai->pos_concluidas) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_de_contato') ? 'is-invalid' : '' }}" type="text" name="numero_de_contato" id="numero_de_contato" value="{{ old('numero_de_contato', $profissionai->numero_de_contato) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('e_mail_de_usuario') ? 'is-invalid' : '' }}" name="e_mail_de_usuario_id" id="e_mail_de_usuario_id">
                    @foreach($e_mail_de_usuarios as $id => $entry)
                        <option value="{{ $id }}" {{ old('e_mail_de_usuario_id', $profissionai->e_mail_de_usuario_id) == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_mail_de_contato') ? 'is-invalid' : '' }}" type="text" name="e_mail_de_contato" id="e_mail_de_contato" value="{{ old('e_mail_de_contato', $profissionai->e_mail_de_contato) }}">
            ...
            <div class="form-group">
                <label for="arquivos_relacionados">{{ trans('cruds.profissionai.fields.arquivos_relacionados') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.profissionai.fields.arquivos_relacionados_helper') }}</span>
            </div>
            <div class="form-group">
