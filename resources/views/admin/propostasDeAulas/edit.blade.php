...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.propostasDeAula.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.propostas-de-aulas.update", [$propostasDeAula->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titulo') ? 'is-invalid' : '' }}" type="text" name="titulo" id="titulo" value="{{ old('titulo', $propostasDeAula->titulo) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('resumo') ? 'is-invalid' : '' }}" name="resumo" id="resumo">{!! old('resumo', $propostasDeAula->resumo) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('autor') ? 'is-invalid' : '' }}" type="text" name="autor" id="autor" value="{{ old('autor', $propostasDeAula->autor) }}">
                @if($errors->has('autor'))
                    <div class="invalid-feedback">
                        {{ $errors->first('autor') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('publico_alvo') ? 'is-invalid' : '' }}" name="publico_alvo" id="publico_alvo">
                    ...
                    @foreach(App\Models\PropostasDeAula::PUBLICO_ALVO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('publico_alvo', $propostasDeAula->publico_alvo) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('area_de_conhecimento') ? 'is-invalid' : '' }}" type="text" name="area_de_conhecimento" id="area_de_conhecimento" value="{{ old('area_de_conhecimento', $propostasDeAula->area_de_conhecimento) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('objetivo') ? 'is-invalid' : '' }}" name="objetivo" id="objetivo">{!! old('objetivo', $propostasDeAula->objetivo) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('metodologia') ? 'is-invalid' : '' }}" type="text" name="metodologia" id="metodologia" value="{{ old('metodologia', $propostasDeAula->metodologia) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('finalidade') ? 'is-invalid' : '' }}" type="text" name="finalidade" id="finalidade" value="{{ old('finalidade', $propostasDeAula->finalidade) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('aceito') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="aceito" id="aceito" value="1" {{ $propostasDeAula->aceito || old('aceito', 0) === 1 ? 'checked' : '' }} required>
