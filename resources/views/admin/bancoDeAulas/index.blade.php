                        ...
                        <tr data-entry-id="{{ $bancoDeAula->id }}">
                            ...
                            <td class="btnn">
                             ...
                             <div class="dropdown">
                              ...
                              @can('remove_bancos') <form  method="POST" action="{{ route('admin.aulas.propostas.upb') }}?id={{$bancoDeAula->id}}" enctype="multipart/form-data"> @csrf
                                <input type="hidden" name="situacao_do_projeto" id="situacao_do_projeto" value="4">
                                <button type="submit" class="btn-submit" value="Remover Aprovação"> <i class="fas fa-minus-circle"></i> Remover Aprovação
                                </form> @endcan
                               </div>
                             </div>
                            </div>
