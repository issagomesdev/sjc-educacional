...
<div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route('admin.aulas.propostas.up') }}" enctype="multipart/form-data">
          @csrf
            ...
            <div class="form-group" id="hidden_div">
                ...
                <input class="form-control" type="text" name="sugestao" id="sugestao" value="{{ old('sugestao', $bancoDeAula->sugestao) }}">
                <span class="help-block"> </span>
            </div>
