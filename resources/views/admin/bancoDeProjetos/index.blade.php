                    ...
                    @foreach($bancoDeProjetos as $key => $bancoDeProjeto)
                        <tr data-entry-id="{{ $bancoDeProjeto->id }}">
                          ...
                          <td>
                              ...
                              <p> <strong>Área de conhecimento:</strong> {{ $bancoDeProjeto->area_de_conhecimento ?? '' }} </p>
                            ...
                            <td class="invisib">
                                {{ $bancoDeProjeto->area_de_conhecimento ?? '' }}
                            </td>
                            <td class="invisib">
                            ...
                            <td class="btnn">
                                ...
                                @can('publish_bancos')
                                @if($bancoDeProjeto->situacao_do_projeto == 1)
                                 <form method="POST" action="{{ route('admin.projetos.propostas.upb') }}?id={{$bancoDeProjeto->id}}" enctype="multipart/form-data">
                                     @csrf
                                     <input type="hidden" name="situacao_do_projeto" id="situacao_do_projeto" value="2">
                                     <button class="btn btn-xs btn-publi" type="submit">
                                         Publicar
                                     </button>
                                     </form>
                                     @endif
                                     ...
                                     @can('remove_bancos')
                                     @if($bancoDeProjeto->situacao_do_projeto == 2)
                                    <form method="POST" action="{{ route('admin.projetos.propostas.upb') }}?id={{$bancoDeProjeto->id}}" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="situacao_do_projeto" id="situacao_do_projeto" value="1">
                                        <button class="btn btn-xs btn-xpubli" type="submit">
                                            Remover publicação
                                        </button>
                                        </form>
                                        @endif
                                         ...
                                         @if($bancoDeProjeto->situacao_do_projeto == 1)
                                          <form method="POST" action="{{ route('admin.projetos.propostas.upb') }}?id={{$bancoDeProjeto->id}}" enctype="multipart/form-data">
                                              @csrf
                                              <input type="hidden" name="situacao_do_projeto" id="situacao_do_projeto" value="4">
                                              <button class="btn btn-xs btn-xaprov" type="submit">
                                                  Remover Aprovação
                                              </button>
                                              </form>
                                              @endif
