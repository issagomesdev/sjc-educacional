...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cadastrar-motorista.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_da_habilitacao') ? 'is-invalid' : '' }}" type="text" name="data_da_habilitacao" id="data_da_habilitacao" value="{{ old('data_da_habilitacao') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('vencimento_da_habilitacao') ? 'is-invalid' : '' }}" type="text" name="vencimento_da_habilitacao" id="vencimento_da_habilitacao" value="{{ old('vencimento_da_habilitacao') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_do_motorista') ? 'is-invalid' : '' }}" type="text" name="codigo_do_motorista" id="codigo_do_motorista" value="{{ old('codigo_do_motorista', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('observacoes') ? 'is-invalid' : '' }}" name="observacoes" id="observacoes">{!! old('observacoes') !!}</textarea>
