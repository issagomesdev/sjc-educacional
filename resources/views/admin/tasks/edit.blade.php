        ...
        <form method="POST" action="{{ route("admin.tasks.update", [$task->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <option value="">Selecione por favor</option>
                    @foreach($tags as $tag)
                        <option value="{{ $tag->id }}" {{ (old('tags') ? old('tags') : $task->tags->contains($id)) ? 'selected' : '' }}>{{ $tag->name }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="date" name="inicio" id="inicio" value="{{ $task->inicio }}">
                <span class="help-block"> </span>
            </div>
            <div class="form-group">
                <label for="fim"> Fim </label>
                <input class="form-control" type="date" name="fim" id="fim" value="{{ $task->fim }}">
                <span class="help-block"> </span>
            </div>
