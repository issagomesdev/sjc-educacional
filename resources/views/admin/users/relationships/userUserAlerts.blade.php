            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-userUserAlerts">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.userAlert.fields.instituicoes') }}
                        </th>
                        <th>
                            {{ trans('cruds.userAlert.fields.hierarquias') }}
                        </th>
                        <th>
                            {{ trans('cruds.userAlert.fields.assinatura') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($userAlerts as $key => $userAlert)
                        <tr data-entry-id="{{ $userAlert->id }}">
                            ...
                            <td>
                                {{ $userAlert->instituicoes->name ?? '' }}
                            </td>
                            <td>
                                {{ $userAlert->hierarquias->title ?? '' }}
                            </td>
                            <td>
