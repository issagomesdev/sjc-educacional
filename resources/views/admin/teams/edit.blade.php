    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teams.update", [$team->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tipo_de_instituicao') ? 'is-invalid' : '' }}" name="tipo_de_instituicao_id" id="tipo_de_instituicao_id">
                    @foreach($tipo_de_instituicaos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('tipo_de_instituicao_id') ? old('tipo_de_instituicao_id') : $team->tipo_de_instituicao->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('owner') ? 'is-invalid' : '' }}" name="owner_id" id="owner_id">
                    @foreach($owners as $id => $entry)
                        <option value="{{ $id }}" {{ (old('owner_id') ? old('owner_id') : $team->owner->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('owner'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Team::LOCALIZACAO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('localizacao') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="localizacao_{{ $key }}" name="localizacao" value="{{ $key }}" {{ old('localizacao', $team->localizacao) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado" id="estado">
                    ...
                    @foreach(App\Models\Team::ESTADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado', $team->estado) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $team->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $team->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('endereco') ? 'is-invalid' : '' }}" type="text" name="endereco" id="endereco" value="{{ old('endereco', $team->endereco) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnpj') ? 'is-invalid' : '' }}" type="text" name="cnpj" id="cnpj" value="{{ old('cnpj', $team->cnpj) }}">
                @if($errors->has('cnpj'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cnpj') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefone_de_contato') ? 'is-invalid' : '' }}" type="text" name="telefone_de_contato" id="telefone_de_contato" value="{{ old('telefone_de_contato', $team->telefone_de_contato) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefone_de_contato_2') ? 'is-invalid' : '' }}" type="text" name="telefone_de_contato_2" id="telefone_de_contato_2" value="{{ old('telefone_de_contato_2', $team->telefone_de_contato_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefone_de_contato_3') ? 'is-invalid' : '' }}" type="text" name="telefone_de_contato_3" id="telefone_de_contato_3" value="{{ old('telefone_de_contato_3', $team->telefone_de_contato_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_de_contato') ? 'is-invalid' : '' }}" type="text" name="email_de_contato" id="email_de_contato" value="{{ old('email_de_contato', $team->email_de_contato) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dependencia_administrativa') ? 'is-invalid' : '' }}" name="dependencia_administrativa" id="dependencia_administrativa">
                    ...
                    @foreach(App\Models\Team::DEPENDENCIA_ADMINISTRATIVA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dependencia_administrativa', $team->dependencia_administrativa) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('situacao') ? 'is-invalid' : '' }}" name="situacao" id="situacao">
                    ...
                    @foreach(App\Models\Team::SITUACAO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('situacao', $team->situacao) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
