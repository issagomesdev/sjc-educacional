...
<div class="card">
    <div class="card-header">
        {{ trans('global.show') }} {{ trans('cruds.categoriasDeProduto.title') }}
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.categorias-de-produtos.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.categoriasDeProduto.fields.id') }}
                        </th>
                        <td>
                            {{ $categoriasDeProduto->id }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.categoriasDeProduto.fields.descricao') }}
                        </th>
                        <td>
                            {{ $categoriasDeProduto->descricao }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $categoriasDeProduto->updated_at }}
                        </td>
                    </tr>
                </tbody>
            </table>
