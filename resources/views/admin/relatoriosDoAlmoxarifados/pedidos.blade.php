...
<div class="card">
    <div class="card-header">
        Relatórios de Pedidos de Compra
    </div>
 </div>

 <div class="grapic">
   <table id="example" class=" table table-bordered table-striped table-hover datatable datatable-pedidos">
     <thead>
         <tr>
...
<script>
  ...
  let table = $('.datatable-pedidos:not(.ajaxTable)').DataTable({ buttons: dtButtons })
