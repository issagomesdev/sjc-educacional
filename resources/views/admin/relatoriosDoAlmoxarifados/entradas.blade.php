...
<div class="card">
    <div class="card-header">
        Relatórios de Entradas no Estoque
    </div>
 </div>

 <div class="grapic">
   <table id="example" class=" table table-bordered table-striped table-hover datatable datatable-entradas">
     <thead>
         <tr>
           ...
           <th style="width: 50%;" aria-sort="none"> Quantidade </th>
           <th style="width: 50%;" aria-sort="none"> Fornecedor </th>
       ...
       <tbody>
         ...
         <td></td>
             <td>
                {{ $entrada->estoque->titulo }}
             </td>
             <td>
                {{ $entrada->produto->titulo }}
             </td>
             <td>
                {{ $entrada->quatidade }}
             </td>
...
<script>
  ...
  let table = $('.datatable-entradas:not(.ajaxTable)').DataTable({ buttons: dtButtons })
