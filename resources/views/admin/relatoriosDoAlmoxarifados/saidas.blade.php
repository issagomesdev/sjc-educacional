...
<div class="card">
    <div class="card-header">
        Relatórios de Saidas no Estoque
    </div>
 </div>

 <div class="grapic">
   <table id="example" class=" table table-bordered table-striped table-hover datatable datatable-saida">
     <thead>
         <tr>
       ...
       <tbody>
         ...
         <td></td>
             <td>
                {{ $saida->estoque->titulo }}
             </td>
             <td>
                {{ $saida->produto->titulo }}
             </td>
             <td>
                {{ $saida->quatidade }}
             </td>
             <td>
                {{ $saida->requisitante->nome }}
             </td>
             <td>
                {{ $saida->created_at }}
             </td>
...
<script>
  ...
  let table = $('.datatable-saida:not(.ajaxTable)').DataTable({ buttons: dtButtons })
