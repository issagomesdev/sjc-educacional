...
<td>
<textarea class="form-control ckeditor" name="conhecendo_contexto" id="conhecendo_contexto" readonly>
...
<td>
<textarea class="form-control ckeditor" name="registro_conquistas" id="registro_conquistas" readonly>
...
<td> @if($notum['01EO01_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01EO01_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01EO02_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01EO02_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01EO03_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01EO03_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
<td> <strong>(EI01EO04PE)</strong> Comunicar necessidades, desejos e emoções, utilizando gestos, balbucios, palavras. </td>
<td> @if($notum['01EO04_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01EO04_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01EO05_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01EO05_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01EO06_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01EO06_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01EO07_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01EO07_s2'] == 1) ✓ @endif </td>
</tr>
</tbody>
<thead>
<tr>
...
<td> @if($notum['02EO01_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02EO01_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['02EO05_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02EO05_s2'] == 1) ✓ @endif </td>
</tr>
<td> <strong>(EI02EO06PE)</strong> Fazer uso de normas sociais, participando de brincadeiras, pertencentes à cultura local. </td>
<td> @if($notum['02EO06_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02EO06_s2'] == 1) ✓ @endif </td>
</tr>
...
<td> @if($notum['02EO07_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02EO07_s2'] == 1) ✓ @endif </td>
</tr>
</tbody>
<thead>
<tr>
...
<td> @if($notum['01ET01_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET01_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01ET02_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET02_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01ET03_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET03_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01ET04_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET04_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01ET05_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET05_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01ET06_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET06_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01ET07_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET07_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['01ET08_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET08_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
<td> <strong>(EI01ET09PE)</strong> Explorar o ambiente natural externo da unidade por meio de passeios. </td>
<td> @if($notum['01ET09_s1'] == 1) ✓ @endif </td>
<td> @if($notum['01ET09_s2'] == 1) ✓ @endif </td>
</tr>
</tbody>
<thead>
<tr>
...
<td> @if($notum['02ET01_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET01_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['02ET02_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET02_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['02ET03_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET03_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['02ET04_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET04_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['02ET05_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET05_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
<td> <strong>(EI02ET06PE)</strong> Utilizar conceitos básicos (agora, depois, depressa, devagar), nas situações as do cotidiano. </td>
<td> @if($notum['02ET06_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET06_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['02ET07_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET07_s2'] == 1) ✓ @endif </td>
</tr>
<tr>
...
<td> @if($notum['02ET08_s1'] == 1) ✓ @endif </td>
<td> @if($notum['02ET08_s2'] == 1) ✓ @endif </td>
</tr>
</tbody>
</table>
<!-- 4 -->
...
<td>
<textarea class="form-control ckeditor" name="parecer_descritivo_s1" id="parecer_descritivo_s1" readonly>
...
<td>
<textarea class="form-control ckeditor" name="parecer_descritivo_s2" id="parecer_descritivo_s2" readonly>
...
<div class="sregistros">
  <p class="mensage"> Não há registros de notas para a o aluno selecionado e no bimestre selecionado, verifique se houve algum erro de preenchimento e tente novamente. </p>
</div>
@endif
