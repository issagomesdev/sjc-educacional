...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-tipoDeAcessoUsers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.user.fields.assinatura') }}
                        </th>
                        <th>
                            {{ trans('cruds.user.fields.assinatura_team') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-tipoDeAcessoUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
