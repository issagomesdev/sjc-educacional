...
<div class="card">
    <div class="card-header">
        Visualizar Suspensão de Aulas
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.semaulas.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.semaula.fields.descricao') }}
                        </th>
                        <td>
                            {!! $semaula->descricao !!}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.semaula.fields.escolas') }}
                        </th>
                        <td>
                        <a href="{{ route('admin.teams.show', $semaula->instituicao->id) }}"> {{$semaula->instituicao->name}} </a>
                        </td>
                    </tr>
                    <tr>
                        <th>
