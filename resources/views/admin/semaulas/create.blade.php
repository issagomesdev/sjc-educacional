...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.semaulas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('de') ? 'is-invalid' : '' }}" type="text" name="de" id="de" value="{{ old('de') }}">
                @if($errors->has('de'))
                    <div class="invalid-feedback">
                        {{ $errors->first('de') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('ate') ? 'is-invalid' : '' }}" type="text" name="ate" id="ate" value="{{ old('ate') }}" required>
                @if($errors->has('ate'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ate') }}
                    </div>
            ...
            @else
            <input type="hidden" class="instituicao_id" value="{{Auth::user()->team_id}}" for="instituicao_id" name="instituicao_id">
            @endif
