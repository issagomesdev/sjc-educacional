...
<div class="card">
    <div class="card-header">
        {{ trans('global.show') }} {{ trans('cruds.deslocar.title') }}
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.deslocars.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.deslocar.fields.id') }}
                        </th>
                        <td>
                            {{ $deslocar->id }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.deslocar.fields.institucao_1') }}
                        </th>
                        <td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.deslocar.fields.institucao_2') }}
                        </th>
                        <td>
