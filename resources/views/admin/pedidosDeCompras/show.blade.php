...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.pedidos-de-compras.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.pedidosDeCompra.fields.id') }}
                        </th>
                        <td>
                            {{ $pedidosDeCompra->id }}
                        </td>
