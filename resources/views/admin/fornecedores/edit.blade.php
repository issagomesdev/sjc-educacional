...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fornecedores.update", [$fornecedore->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="razao">{{ trans('cruds.fornecedore.fields.razao') }}</label>
                <input class="form-control {{ $errors->has('razao') ? 'is-invalid' : '' }}" type="text" name="razao" id="razao" value="{{ old('razao', $fornecedore->razao) }}">
                @if($errors->has('razao'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" type="text" name="nome" id="nome" value="{{ old('nome', $fornecedore->nome) }}" required>
                @if($errors->has('nome'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nome') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cep') ? 'is-invalid' : '' }}" type="text" name="cep" id="cep" value="{{ old('cep', $fornecedore->cep) }}">
                @if($errors->has('cep'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cep') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado" id="estado">
                    ...
                    @foreach(App\Models\Fornecedore::ESTADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado', $fornecedore->estado) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $fornecedore->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $fornecedore->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('endereco') ? 'is-invalid' : '' }}" type="text" name="endereco" id="endereco" value="{{ old('endereco', $fornecedore->endereco) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero') ? 'is-invalid' : '' }}" type="text" name="numero" id="numero" value="{{ old('numero', $fornecedore->numero) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('complemento') ? 'is-invalid' : '' }}" type="text" name="complemento" id="complemento" value="{{ old('complemento', $fornecedore->complemento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rg') ? 'is-invalid' : '' }}" type="text" name="rg" id="rg" value="{{ old('rg', $fornecedore->rg) }}">
                @if($errors->has('rg'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rg') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefone_1') ? 'is-invalid' : '' }}" type="text" name="telefone_1" id="telefone_1" value="{{ old('telefone_1', $fornecedore->telefone_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefone_2') ? 'is-invalid' : '' }}" type="text" name="telefone_2" id="telefone_2" value="{{ old('telefone_2', $fornecedore->telefone_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contato') ? 'is-invalid' : '' }}" type="text" name="contato" id="contato" value="{{ old('contato', $fornecedore->contato) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banco') ? 'is-invalid' : '' }}" type="text" name="banco" id="banco" value="{{ old('banco', $fornecedore->banco) }}">
                @if($errors->has('banco'))
                    <div class="invalid-feedback">
                        {{ $errors->first('banco') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agencia') ? 'is-invalid' : '' }}" type="text" name="agencia" id="agencia" value="{{ old('agencia', $fornecedore->agencia) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conta') ? 'is-invalid' : '' }}" type="text" name="conta" id="conta" value="{{ old('conta', $fornecedore->conta) }}">
                @if($errors->has('conta'))
                    <div class="invalid-feedback">
                        {{ $errors->first('conta') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $fornecedore->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site') ? 'is-invalid' : '' }}" type="text" name="site" id="site" value="{{ old('site', $fornecedore->site) }}">
                @if($errors->has('site'))
                    <div class="invalid-feedback">
                        {{ $errors->first('site') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('observacoes') ? 'is-invalid' : '' }}" name="observacoes" id="observacoes">{{ old('observacoes', $fornecedore->observacoes) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('situacao') ? 'is-invalid' : '' }}" name="situacao" id="situacao">
                    ...
                    @foreach(App\Models\Fornecedore::SITUACAO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('situacao', $fornecedore->situacao) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
